...
- Workspace ID: `9b3c687c-7f0a-4716-91a9-1e456b5b0206`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/9b3c687c-7f0a-4716-91a9-1e456b5b0206.
...
2. `npx ngodingpakeai connect --workspace 9b3c687c-7f0a-4716-91a9-1e456b5b0206 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/9b3c687c-7f0a-4716-91a9-1e456b5b0206. Only pass on links the CLI actually printed — never assemble one from an id yourself.
